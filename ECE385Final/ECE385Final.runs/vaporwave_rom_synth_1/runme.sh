...
HD_PWD='C:/Users/merli/ECE385Final/ECE385Final/ECE385Final.runs/vaporwave_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vaporwave_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vaporwave_rom.tcl
