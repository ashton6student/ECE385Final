...
HD_PWD='C:/Users/merli/ECE385Final/ECE385Final/ECE385Final.runs/titleScreen_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log titleScreen.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source titleScreen.tcl
