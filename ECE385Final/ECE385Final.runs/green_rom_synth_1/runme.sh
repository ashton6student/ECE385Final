...
HD_PWD='C:/Users/merli/ECE385Final/ECE385Final/ECE385Final.runs/green_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log green_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source green_rom.tcl
