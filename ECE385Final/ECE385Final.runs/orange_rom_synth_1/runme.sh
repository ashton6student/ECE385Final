...
HD_PWD='C:/Users/merli/ECE385Final/ECE385Final/ECE385Final.runs/orange_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log orange_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source orange_rom.tcl
