...
HD_PWD='C:/Users/merli/ECE385Final/ECE385Final/ECE385Final.runs/yellow_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log yellow_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source yellow_rom.tcl
