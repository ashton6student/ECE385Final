...
#
# Generated by export_simulation on Fri Apr 26 15:04:34 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './orange_rom.sh' script.

./orange_rom.sh -reset_run
...
./orange_rom.sh -noclean_files

For more information on the script, please type './orange_rom.sh -help'.
