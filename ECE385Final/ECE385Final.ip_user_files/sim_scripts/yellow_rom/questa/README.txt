...
#
# Generated by export_simulation on Fri Apr 26 15:03:46 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './yellow_rom.sh' script.

./yellow_rom.sh -reset_run
...
./yellow_rom.sh -noclean_files

For more information on the script, please type './yellow_rom.sh -help'.
