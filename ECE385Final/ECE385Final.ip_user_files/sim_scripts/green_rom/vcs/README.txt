...
#
# Generated by export_simulation on Fri Apr 26 15:00:12 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './green_rom.sh' script.

./green_rom.sh -reset_run
...
./green_rom.sh -noclean_files

For more information on the script, please type './green_rom.sh -help'.
