...
#
# Generated by export_simulation on Tue Apr 30 01:00:50 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './countdown_rom.sh' script.

./countdown_rom.sh -reset_run
...
./countdown_rom.sh -noclean_files

For more information on the script, please type './countdown_rom.sh -help'.
