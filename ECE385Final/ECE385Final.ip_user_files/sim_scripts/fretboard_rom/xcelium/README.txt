...
#
# Generated by export_simulation on Thu Apr 25 00:48:43 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './fretboard_rom.sh' script.

./fretboard_rom.sh -reset_run
...
./fretboard_rom.sh -noclean_files

For more information on the script, please type './fretboard_rom.sh -help'.
