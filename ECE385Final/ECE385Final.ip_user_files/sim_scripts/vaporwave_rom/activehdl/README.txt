...
#
# Generated by export_simulation on Thu Apr 25 00:20:37 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './vaporwave_rom.sh' script.

./vaporwave_rom.sh -reset_run
...
./vaporwave_rom.sh -noclean_files

For more information on the script, please type './vaporwave_rom.sh -help'.
